            ...
            >
              <div className="bg-white rounded-3xl p-8 md:p-12 shadow-lg relative" style={{ boxShadow: '0 10px 40px -10px rgba(0,0,0,0.1)' }}>
                ...
                <div className="flex items-center gap-4">
                  {/* Avatar */}
                  <div className="w-14 h-14 rounded-full flex items-center justify-center flex-shrink-0 bg-gradient-to-br from-navy to-navy-dark relative overflow-hidden">
                    {/* Silhouette */}
                    <svg className="w-8 h-8 text-white/30 absolute bottom-0" viewBox="0 0 24 24" fill="currentColor">
